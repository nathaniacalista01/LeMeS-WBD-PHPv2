			...
			<div class="report-container">
				...
				<div class="report-body">
                    <div class="container">
                        <div id="edit-popup">
                            <div class="window">
                                <a onclick="handleClose('edit')" class="close-button" title="Close">X</a>
                                <h2>Edit user with id <span id="user_id"><span></h2>
                                <div class="clearfix">
                                    ...
                                    foreach ($users as $user) {
                                        ...
                                        echo"
                                            <tr>
                                                ...
                                                <td class='action'>
                                                    <span class='edit-icon' onclick='handleOpen(\"edit\",\"$user_id\")'>
